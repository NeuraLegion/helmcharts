...
app.kubernetes.io/name: {{ include "juiceshop.name" . }}
...
*/}}
{{- define "juiceshop.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "juiceshop.fullname" .) .Values.serviceAccount.name }}
{{- else }}
